...
function DataTable(props) {
  ...
  const { search, total, limit, skip, moveNext, movePrev, changeLimit, deleteValue, setActionDelete, editValue, setActionEdit, setEditData } = props;
                      ...
                      {page.map((row, i) => {
                        ...
                        return (
                          <tr key={row.id} {...row.getRowProps()}>
                            ...
                            {console.log('PAGE --------', row.values)}
                            <td className="flex m-auto align-middle justify-center">
                              {props.showEdit == true && (
                                <a
                                  onClick={() => {
                                    
                                    setActionEdit(true, row.id, row.values);
                                  } }
                              ...
                              {props.showDelete == true && (
                                <a
                                  onClick={() => setActionDelete(true, row.id)}
